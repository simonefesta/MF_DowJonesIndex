...
# Note that in the above data frames, the temporal ordering of the rows, accounted by the column Date, against the row names is decreasing: 
# following the order of the row names, the rows go from the most recent to the least recent.
# However, for our purposes, it is more convenient to dispose of data in increasing temporal order (from the least recent to the most recent).
# Therefore, we invert the temporal order of the rows in the data frames.
...
#
Ext_ESM23.CME_df <- add_column(.data=Ext_ESM23.CME_df, 
                               Ret.Rate.at.Maturity=(Ext_ESM23.CME_df$ESM23.CME.Adjusted/Ext_ESM23.CME_df$GSPC.Adjusted-1),
                               Perc.Ret.Rate.at.Maturity=label_percent(accuracy = 0.001)(Ext_ESM23.CME_df$ESM23.CME.Adjusted/Ext_ESM23.CME_df$GSPC.Adjusted-1),
                               Ann.Ret.Rate.at.Maturity=((Ext_ESM23.CME_df$ESM23.CME.Adjusted/Ext_ESM23.CME_df$GSPC.Adjusted)^(365.2425/Ext_ESM23.CME_df$Days.to.Maturity)-1),
                               Perc.Ann.Ret.Rate.at.Maturity=label_percent(accuracy = 0.001)((Ext_ESM23.CME_df$ESM23.CME.Adjusted/Ext_ESM23.CME_df$GSPC.Adjusted)^(365.2425/Ext_ESM23.CME_df$Days.to.Maturity)-1),
